...
// No official USDC mark ships in simple-icons - this is Streamline's "Usdc"
// cryptocurrency icon (https://streamlinehq.com), provided directly.
export function UsdcIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 16 16" className={className} xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        fill="#3e73c4"
