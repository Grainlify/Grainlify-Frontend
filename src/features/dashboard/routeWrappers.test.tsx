...
describe('routeWrappers security validation', () => {
  describe('OpenSourceWeekDetailPageRoute', () => {
    it('renders detail page for a valid eventId', () => {
      renderWithRouter(<OpenSourceWeekDetailPageRoute />, '/dashboard/osw/event-123', '/dashboard/osw/:eventId');
      expect(screen.getByTestId('osw-detail')).toBeInTheDocument();
    });

    it('renders ResourceNotFound for an invalid eventId (path traversal)', () => {
      renderWithRouter(<OpenSourceWeekDetailPageRoute />, '/dashboard/osw/..%2F..%2Fetc%2Fpasswd', '/dashboard/osw/:eventId');
      expect(screen.getByText(/event not found/i)).toBeInTheDocument();
    });

    it('renders ResourceNotFound for an overly long eventId', () => {
      const longId = 'a'.repeat(101);
      renderWithRouter(<OpenSourceWeekDetailPageRoute />, `/dashboard/osw/${longId}`, '/dashboard/osw/:eventId');
      expect(screen.getByText(/event not found/i)).toBeInTheDocument();
    });
  });
  ...
  describe('EcosystemDetailPageRoute', () => {
    it('renders detail page for a valid ecosystemId', () => {
      renderWithRouter(<EcosystemDetailPageRoute />, '/dashboard/ecosystems/solana', '/dashboard/ecosystems/:ecosystemId');
  ...
  describe('ProjectDetailPageRoute', () => {
    it('renders detail page for a valid projectId', () => {
      renderWithRouter(<ProjectDetailPageRoute />, '/dashboard/projects/uuid-123', '/dashboard/projects/:projectId');
      expect(screen.getByTestId('project-detail')).toBeInTheDocument();
    });

    it('renders ResourceNotFound for an invalid projectId (dots)', () => {
      renderWithRouter(<ProjectDetailPageRoute />, '/dashboard/projects/project.id', '/dashboard/projects/:projectId');
  ...
  describe('IssueDetailPageRoute', () => {
    it('renders detail page for valid projectId and issueId', () => {
      renderWithRouter(<IssueDetailPageRoute />, '/dashboard/projects/p1/issues/i1', '/dashboard/projects/:projectId/issues/:issueId');
      expect(screen.getByTestId('issue-detail')).toBeInTheDocument();
    });

    it('renders ResourceNotFound if projectId is invalid', () => {
      renderWithRouter(<IssueDetailPageRoute />, '/dashboard/projects/p.1/issues/i1', '/dashboard/projects/:projectId/issues/:issueId');
      expect(screen.getByText(/issue not found/i)).toBeInTheDocument();
    });

    it('renders ResourceNotFound if issueId is invalid', () => {
      renderWithRouter(<IssueDetailPageRoute />, '/dashboard/projects/p1/issues/i_1', '/dashboard/projects/:projectId/issues/:issueId');
      expect(screen.getByText(/issue not found/i)).toBeInTheDocument();
    });
  });
  ...
  describe('BlogArticlePageRoute', () => {
    it('renders article page for a valid slug', () => {
      renderWithRouter(<BlogArticlePageRoute />, '/dashboard/blog/safe-slug-123', '/dashboard/blog/:slug');
      expect(screen.getByTestId('blog-article')).toBeInTheDocument();
    });

    it('renders ResourceNotFound for a malformed slug (encoded)', () => {
      renderWithRouter(<BlogArticlePageRoute />, '/dashboard/blog/encoded%20slug', '/dashboard/blog/:slug');
