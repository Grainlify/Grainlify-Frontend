...
describe('Auth pages localized strings', () => {
  ...
  it('renders sign-in labels and consent copy from the i18n catalog', () => {
    ...
    expect(
      screen.getByRole('heading', { name: 'Localized sign-in title' }),
    ).toBeInTheDocument();
    expect(screen.getByText('Localized sign-in subtitle')).toBeInTheDocument();
    expect(
      screen.getByRole('button', { name: 'Localized sign-in GitHub' }),
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByRole('link', { name: 'Localized sign-in signup link' }),
  ...
  it('renders sign-up labels, consent copy, and legal links from the i18n catalog', () => {
    ...
    expect(
      screen.getByRole('heading', { name: 'Localized sign-up title' }),
    ).toBeInTheDocument();
    expect(screen.getByText('Localized sign-up subtitle')).toBeInTheDocument();
    expect(
      screen.getByRole('button', { name: 'Localized sign-up GitHub' }),
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByRole('link', { name: 'Localized sign-up signin link' }),
