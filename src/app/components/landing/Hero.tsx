...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 pt-20">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-[#d4af37]/20 blur-3xl animate-pulse delay-1000" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            to="/signup"
            className="group px-8 py-4 rounded-[16px] bg-gradient-to-r from-[#c9983a] to-[#d4af37] text-white font-medium hover:shadow-2xl hover:shadow-[#c9983a]/50 transition-all flex items-center space-x-2"
          >
          ...
          <a
            href="#features"
            className={`px-8 py-4 rounded-[16px] backdrop-blur-[30px] border font-medium transition-all ${
              theme === 'dark'
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={stat.label}
              className={`backdrop-blur-[40px] border rounded-[20px] p-6 transition-all hover:border-[#c9983a]/30 hover:shadow-[0_12px_36px_rgba(201,152,58,0.15)] ${
                theme === 'dark'
